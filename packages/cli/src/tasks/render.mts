...
import {BROWSER_EXECUTABLE, CONCURRENCY, DEFAULT_CONFIG, parseConfig} from "./config.mjs";

/** Render to static video. */
export const render = (yargs: typeof Yargs) => yargs.command(
  "render",
  "Render static video",
  yargs => yargs
    ...
    // Input options
    .group(["duration", "end", "sequence", "start", "color-scheme"], "Input options")
    .option("start", {
      alias: "s",
      coerce: coerceTime,
      default: "00:00",
